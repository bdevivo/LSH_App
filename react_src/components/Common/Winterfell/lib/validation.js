 ...
 */
let validateAnswer = (value, validationItem, questionAnswers) => {
  let validationMethod = typeof extraValidators[validationItem.type] !== 'undefined'
 ...
 */
let getActiveQuestions = (questions, questionAnswers, activeQuestions) => {
 ...
 * @return array                  All active questions
 */
let getActiveQuestionsFromQuestionSets = (questionSets, questionAnswers) => {
 ...
 */
let getQuestionPanelInvalidQuestions = (questionSets, questionAnswers) => {
  let questionsToCheck = getActiveQuestionsFromQuestionSets(questionSets, questionAnswers)
                           .filter(question => {
  ...
  questionsToCheck
    .forEach(({questionId, validations}) =>
      [].forEach.bind(validations, validation => {
        let valid = validateAnswer(questionAnswers[questionId],
                                   validation,
                                   questionAnswers);
        if (valid) {
          return;
 ...
 */
let addValidationMethod = (name, method) => {
 ...
 */
let addValidationMethods = (methods) => {
