...
const QSetQuestionAddEdit = ({qSetQuestion, questions, questionSetFunctions, canAddConditionalQuestion}) => {

   let {onQuestionChanged} = questionSetFunctions;
   let labelColSize = 2;
   let inputColSize = 8;
               ...
               <FormGroup styleName="conditionalActionFormGroup">
                  ...
                  <Col sm={6}>
                     <Button type="button" className="btn btn-sm btn-default"
                             ...
                             onClick={questionSetFunctions.addConditionalQuestion}>Add New</Button>
                  </Col>
               </FormGroup>
